...
namespace DigitalRubyShared
{
    ...
    public class TapGestureRecognizer : GestureRecognizer
    {
        ...
        private void VerifyFailGestureAfterDelay()
        {
            ...
            if (State == GestureRecognizerState.Possible && elapsed >= ThresholdSecondsAfterRelease)//-----------------------------------------------------
            {
        ...
        {
            RunActionAfterDelay(ThresholdSecondsAfterRelease, VerifyFailGestureAfterDelay);//--------------------------------------
        }
        ...
        protected override void TouchesMoved()
        {
            ...
            if (timer.Elapsed.TotalSeconds >= ThresholdHoldSeconds)
            {
                SetState(GestureRecognizerState.Failed);
            }
        }
        ...
        {
            if ((float)timer.Elapsed.TotalSeconds <= ThresholdHoldSeconds)
            {
                CalculateFocus(CurrentTrackedTouches);
        ...
        public TapGestureRecognizer()
        {
            ...
            ThresholdHoldSeconds = 0.4f;
            ThresholdSecondsAfterRelease = 0.4f;
            ThresholdUnits = 0.3f;
        ...
        public float ThresholdHoldSeconds { get; set; }

        /// <summary>
        /// How many seconds must pass to fail the gesture in case the gesture requires more than 1 tap - default is 0.4.
        /// </summary>
        /// <value>The threshold in seconds</value>
        public float ThresholdSecondsAfterRelease { get; set; }
