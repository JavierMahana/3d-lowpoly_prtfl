...
namespace UnityEditor.AI
{
    ...
    class NavMeshSurfaceEditor : Editor
    {
        ...
        {
            var prefabInstanceStatus = PrefabUtility.GetPrefabInstanceStatus(navSurface);//--------------yo lo modifique
            var prefaType = PrefabUtility.GetPrefabAssetType(navSurface);//--------------yo lo modifique

            if (prefaType == PrefabAssetType.Regular || prefabInstanceStatus == PrefabInstanceStatus.Disconnected)//--------------yo lo modifique
            {
                // Don't allow deleting the asset belonging to the prefab parent
                var parentSurface = PrefabUtility.GetCorrespondingObjectFromSource<NavMeshSurface>(navSurface);//--------------yo lo modifique
