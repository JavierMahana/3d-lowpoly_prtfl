...
namespace UnityEngine.AI
{
    ...
    public class NavMeshSurface : MonoBehaviour
    {
        ...
        bool UnshareNavMeshAsset()
        {
            ...
            var prefabType = UnityEditor.PrefabUtility.GetPrefabAssetType(this);// ----------------aca fue modificado por mí
            if (prefabType == UnityEditor.PrefabAssetType.Regular)// ----------------aca fue modificado por mí
                return false;


            // An instance can share asset reference only with its prefab parent
            var prefab = UnityEditor.PrefabUtility.GetCorrespondingObjectFromSource<NavMeshSurface>(this); // ----------------aca fue modificado por mí
